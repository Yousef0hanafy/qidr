...
export function HeroSection({
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-64 bg-[#D4956A]/5 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative z-10 max-w-[552px] mx-auto px-4 py-6 flex flex-col items-center gap-4">
        ...
        >
          <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-[#D4956A]/30">
            <Image
              src="/Qidr.avif"
              alt="Qidr Logo"
              width={48}
          ...
          <div className="flex items-baseline gap-2">
            <span className="text-2xl font-bold text-[#D4956A]">قدر</span>
            <span className="text-white/20 text-sm">/</span>
            <span className="text-sm font-medium text-[#D4C8BB]/50">Qidr</span>
          </div>
        </motion.div>
